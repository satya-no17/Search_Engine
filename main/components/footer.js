...
const Footer = () => {
    return (
        <footer className='h-full border-t border-gray-200 dark:border-gray-800 py-4 px-4 bg-white dark:bg-gray-900 transition-colors flex justify-between items-center'>
